...
try:
    ...
    message = '''My test comment with @ reference @buzzapiplayground@gmail.com via the Python Buzz client'''

    comment = buzz.Comment(content=message, post_id='tag:google.com,2010:buzz:z12ltdq4bky1tzw5004cftt4msq3y3kj144')
    buzz_client.create_comment(comment)
    print 'Comment posted: %s' % message
